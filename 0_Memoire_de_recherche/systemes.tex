...
\begin{table}[h]
	...
	%	\label{tab:exemple}
\end{table}
\includegraphics[height=65mm, width=150mm]{images/notation/description_notation.png}\\\\
Si la vélocité est en dessous de 40, il s’agit de ghost-notes : la tête de note devra être entouré de parenthèses et le suffixe \textit{-g} devra être ajouté au codes de l’instument. (Voir cc-g ci-dessus.)\\\\
...
\includegraphics[height=65mm, width=115mm]{images/notation/experimentations/system_drummer_01_session1_004.png}\\
