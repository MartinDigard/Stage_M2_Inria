...
\begin{itemize}
	\item Problème de métrique : sur le premier temps, musescore traite le fla comme si sa note principale était une croche suivie d’un demi soupir
	\item Musescore ne reconnaît qu’une mesure quand la TM en transcrit deux.
	\item Les deux flas ne sont pas reconnus comme étant chacun une note ornementée mais comme un mélange de deux notes à très courte durée (triple ou quadruple croche).
\end{itemize}
