...
\subsection*{Systèmes}
Le motif 1 de la figure \ref{motifs_gammes} est utilisé pour la suite de l’expérimentation théorique.
\begin{figure}[h]
	\centering
	\includegraphics[height=75mm, width=85mm]{z_images/4_experimentations/2_experimentation_theorique/2_systeme_4-4_binaire.png}
	\caption{Motif et gammes combinés}
	\label{sys_motif_1}
\end{figure}\\
La figure \ref{sys_motif_1} ci-dessus illustre le système complet (motif et gammes combinés).
\newpage
