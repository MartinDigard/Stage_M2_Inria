...
\section{Corpus}
Le Groove MIDI Dataset (GMD) est composé de 13,6 heures de batterie jouée par des humains sous forme de fichiers MIDI et audio alignés.
Le corpus contient 1150 fichiers MIDI et plus de 22 000 mesures de batterie dans les styles les plus courant et avec différentes qualités de jeu.\\\\
\textbf{groove MIDI dataset}\\
\url{https://magenta.tensorflow.org/datasets/groove}\\\\
\includegraphics[height=60mm, width=60mm]{z_images/4_experimentations/0_groove/0_roland_TD11.png}\\
Des batteurs pro ont été engagés pour jouer sur un roland td-11\\\\
\includegraphics[height=80mm, width=110mm]{z_images/4_experimentations/0_groove/1_dataset_how.png}\newpage{}
\textbf{Les métadatas :}\\\\
\includegraphics[height=85mm, 
width=100mm]{z_images/4_experimentations/0_groove/2_csv_metadata_struct.png}\\
\includegraphics[height=50mm, width=120mm]{z_images/4_experimentations/0_groove/3_train_validation_test.png}\\
