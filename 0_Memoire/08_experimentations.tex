...
\includegraphics[height=60mm, width=60mm]{z_images/4_experimentations/0_groove/roland_TD11.png}\\
Des batteurs pro ont été engagés pour jouer sur un roland td-11\\\\
\includegraphics[height=80mm, width=110mm]{z_images/4_experimentations/0_groove/dataset_how.png}\newpage{}
\textbf{Les métadatas :}\\\\
\includegraphics[height=85mm, 
width=100mm]{z_images/4_experimentations/0_groove/csv_metadata_struct.png}\\
\includegraphics[height=50mm, width=120mm]{z_images/4_experimentations/0_groove/train_validation_test.png}\\
...
\subsection*{Motifs}
\begin{figure}[h]
	\includegraphics[height=30mm, width=40mm]{z_images/3_methodes/2_systemes/4_motifs_4-4_binaires.png}
	\caption{Motifs}
\end{figure}
...
\subsection*{Gammes}
\includegraphics[height=70mm, width=95mm]{z_images/3_methodes/2_systemes/5_gammes_4-4_binaires.png}\\
