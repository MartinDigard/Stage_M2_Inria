...
\begin{center}
  \begin{tabularx}{\textwidth}{m{10.3cm}m{4cm}}
	 \includegraphics[width = 3.9cm]{z_images/0_logos/logo-inalco.png} %% CG : 3.5cm au lieu de 3 cm
	&
	 ...
	 \includegraphics[width = 3.9cm]{z_images/0_logos/logo-inria.png} %% CG : 3.5cm au lieu de 3 cm
        \\ \hline
  \end{tabularx}
\end{center}
