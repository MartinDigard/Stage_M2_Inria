...
\begin{table}[h]
	...
	\end{tabular}
	\caption{Vélocité, accentuation et ghost-notes}
%	\label{vel_acc_gn}
\end{table}
Les accents et les ghost-notes joués avec les pieds ne sont pas significatifs car certaines vélocités en dessous de 40 étant détectées et inscrites dans les données MIDI sont dûs au mouvement du talon du batteur qui bat la pulsation sans particulièrement jouer le charley. Ce mouvement est perçu par le capteur de la batterie électronique mais le charley n’est pas joué.\\
