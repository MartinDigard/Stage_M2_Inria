...
La figure \ref{AMT_presentation} est une proposition de Benetos et al. (mettre le « et al. » en italique ?) \cite{future_directions} qui représente l'architecture générale d'un système de transcription musicale. On y observe plusieurs sous-tâches de l’AMT :
\begin{itemize}
