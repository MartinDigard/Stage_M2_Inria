...
\input{02_macros} % macros diverses personnelles 
...
\input{04_presentation_generale}
...
\input{06_2_types_donnees}
\section{Transcription MIDI vers partition}
\input{06_3_midi_vers_partition}
...
\section{Introduction}
Dans ce chapitre, nous expliquerons en détails les méthodes employées pour améliorer le processus décrit dans le chapitre précédent.
\newpage
