...
Dans ce chapitre, nous observerons les différentes avancées qui ont déjà eues lieues dans le domaine de la transcription automatique de la musique et de la batterie afin de situé notre démarche. Actuellement, des modèles polyvalent qui n’arrivent pas à récupérer toute la richesse des sons sont utilisés.
