...
Actuellement, de nombreux travaux de MIR font
...
de l’utilité et du problème de l’AMT et de la transcription automatique de la batterie
(ADT).\\
...
\florent{je réfererais plutôt à "Computer Music": 
utilisation de méthodes numériques pour l'analyse et la synthèse
de musique, qu'il s'agisse d'innformation audio ou symbolique
(aide à l'écriture, transcription, base de partitions...) de musique}
...
\florent{? psycho-acoustique, neuro-sciences ?}
dans la musique.\\
...
\florent{exemples / illustration de la proximité thématique ?}D’autres travaux très récents, ont aussi été révélés lors de la
...
\end{table}
\florent{objectifs similaires sur le papier: speech-to-text, 
...
\florent{l'intérêt est aussi d'avoir des partitions au contenu exploitable (texte ou XML) 
         vs images (pdf...)
cf. par ex. cette présentation d'OpenScore à FOSDEM https://archive.fosdem.org/2017/schedule/event/openscore/ et mes transparents sur le sujet}
D'un point
