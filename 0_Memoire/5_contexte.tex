...
de l’utilité et du problème de l’AMT et de la transcription automatique de la
batterie (ADT).\\
...
successives}. 
\florent{vaste champ de recherche pluridisciplinaire, à l'intersection de
acoustique, signal, synthèse sonore, informatique, sciences cognitives,
neurosciences, musicologie...}
...
\cite{MIR_1}. 
\florent{sujet: la recherche et extraction d'information à partir de données
musicales.}
...
% \textit{Ici, Digression sur la musicologie calculatoire vs linguistique
% computationnelle ?}\\\\
