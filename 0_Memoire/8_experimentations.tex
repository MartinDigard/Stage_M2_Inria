...
\section{Expérimentation d’une forme rythmique}
\label{expe_theo}
...
\begin{figure}[h]
	...
	\label{sys_binaire}
\end{figure}
\subsection*{Représentation du forme rythmique en arbres de rythmes}
\label{demo_sys}
\begin{figure}[h]
	\centering
	\resizebox{350pt}{!} {
...
Lilypond vers MIDI + ouput vers MIDI $\Rightarrow$ Comparaison des MIDI dumpés.\\
	...
	%Reconnaître un motif (forme rythmique) sur une mesure de l’input (un fichier midi
    ...
    %\item écrire des règles de réécriture spécifique aux charley avec un forme rythmique
    %approprié.
