...
%Même si on favorise l’usage des silences pour l’écart entre les notes n’appartenant pas au même temps, on les supprime systèmatiquement pour 2 notes au sein d’un même temps.\\
%Exemples :\\
%\begin{figure}[h]
%	\centering
%	\includegraphics[height=30mm, width=30mm]{z_images/}
%\end{figure}
