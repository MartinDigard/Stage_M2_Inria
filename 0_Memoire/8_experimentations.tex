...
Dans ce chapitre, nous présenterons le jeu de données, les analyses MIDI-Audio
accompagnées de conclusions sur l’ensemble des transcriptions manuelles et des
analyses. Nous aborderons le passage du monophonique au polyphonique,
indispensable pour la suite du travaile et pour l’usage des formes rythmiques.
