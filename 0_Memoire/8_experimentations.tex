...
\begin{figure}[h]
	...
	\caption{}
\end{figure}
%	\includegraphics[height=11mm, width=30mm]{z_images/4_experimentations/2_experimentation_theorique/simplification_6.png}\ \ \ \ \ $\Rightarrow$\ \ \ \ \
%	\includegraphics[height=11mm, width=30mm]{z_images/4_experimentations/2_experimentation_theorique/simplification_7.png}
%	\caption{}
%\end{figure}
%
%\begin{figure}[h]
