...
Dans ce chapitre, nous présenterons le jeu de données et les analyses audio-MIDI. Nous ferons ensuite l’expérimentation théorique d’un \textit{système} implémentable qui devra être utilisé comme base de connaissances pour augmenter la rapidité et la qualité en sortie de Qparse. Nous présenterons ensuite les avancées réalisée dans ce travail et une réflexion sur les moyens de l’évaluer. Enfin, nous finirons par une discussion sur l’ensemble du travail réalisé.
...
%\subsection{Bilan sur les travaux réalisés}
